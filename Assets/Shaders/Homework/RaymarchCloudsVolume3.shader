Shader "Custom/RaymarchCloudsVolume"
{
    Properties
    {
        ...
        _MaxHeight ("Max Height", Range (0.1, 10.0)) = 10
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                return float3 ( random(value, float3(0.1, 0.32, 0.22)),
                                random(value, float3(0.3, 0.12, 0.02)),
                                random(value, float3(0.4, 0.79, 0.4)));
            }
